<?php
	...
	// Page setup
	$_PAGE = array ();
	$title='Administrar Traslados Recibidos (Buscar por Fechas)';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='$filename' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Traslado</a>";
				echo "</div>";
				//permiso del script
						  ...
						  <div class="input-group">
                            ...
                            <div class="col-md-4">
								...
								<div class="form-group">
										...
										<button type="button" id="btnMostrar" name="btnMostrar" class="btn btn-primary"><i class="fa fa-check"></i> Mostrar Traslados</button>
...
<?php
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_traslados_recibidos_rangos.js'></script>";
		} //permiso del script
else {
