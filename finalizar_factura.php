...
<div class="modal-header">
	...
	<h4 class="modal-title">Solo Finalizar factura</h4>
</div>
			...
			<!--div class="col-lg-12"-->
				...
				<table class="table table-bordered table-striped" id="tableview">
					...
					<tbody>
						...
						<tfoot>
						<td align='center'><button type="button" class="btn btn-primary" id="btnFinFact"><i class="fa fa-check"></i> Finalizar</button> </td>
