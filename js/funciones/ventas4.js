...
$(document).ready(function(){
  ...
  //$('table#inventable> tbody tr').keynavigator();
...
function addProductList(id_prod,cantidad) {
  ...
  $.ajax({
    ...
    //  if (existencias>0){
   var lista1='<input class="tt typeahead" value="'+precio1+'""/>';
/*
...
*/
   var selectize1=datax.select_precios
     tr_add = '';
     tr_add += '<tr class="row100 body">';
     tr_add += "<td class='cell100 column1'><input type='hidden'  id='exento' name='exento' value='" + exento + "'>" + id_prod + "</td>";
     tr_add += '<td class="cell100 column1">' + descrip +' '+marca+' modelo:'+modelo+ '</td>';
     tr_add += "<td class='cell100 column1' id='cant_stock'>" + existencias + "</td>";
     tr_add += "<td class='cell100 column1' id='select_prec'>" +selectize1+ "</td>";
     tr_add += "<td class='cell100 column1'><input type='hidden'  id='precio_venta_inicial' name='precio_venta_inicial' value='"+datax.precio1+"'><div class='col-xs-2'><input type='text'  class='form-control decimal'  id='precio_venta' name='precio_venta' value='"+datax.precio1+"' style='width:60px;'></div></td>";
     tr_add += "<td class='cell100 column1'><input type='hidden'  id='cant_restada' name='cant_restada' value='"+"1"+"'><div class='col-xs-2'><input type='text'  class='form-control decimal qty' id='cant' name='cant' value='"+cantidad+"' style='width:60px;'></div></td>";
     tr_add += "<td class='cell100 column1 subtotals' id='subtotal'>"+subt_mostrar+"</td>";
     tr_add += "<td class='cell100 column1'><div class='col-xs-2'><input type='text'  class='form-control decimal' id='descto' name='descto'  value='"+valor_descuento+"' style='width:60px;'></div></td>";
     tr_add += '<td class="cell100 column1">'+"<input type='hidden'  id='subt_descto' name='subt_descto' value='0.0'>"  + subt_gravado+ '</td>';
     tr_add += '<td class="cell100 column1" id="subt_exento">' +garantia+ '</td>';
     tr_add += '<td class="Delete cell100 column1"><input id="delprod" type="button" class="btn btn-danger fa"  value="&#xf1f8;"></td>';
     tr_add += '</tr>';
