...
<page backtop="40mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimgx="center" backimgy="bottom" backimgw="100%">
    <page_header>
        ...
        <table class="page_header" >
            ...
            <tr>
            <td align=center style='width:100%;'>REPORTE DE VENTAS POR EMPLEADO </td>
            </tr>
            <tr>
...
/*
	...
	FROM factura,factura_detalle,producto, usuario
    ...
    <table border='0.5px' align='center' cellspacing='0'  style='width: 100%; border:none; text-align: center; font-size: 11pt; color:#000; font-family:helvetica,serif;'>
		...
		echo "<td style='width:20%;text-align:left'>".$nombre."</td>";
 ...
 //inicia validar consolidado
    ...
    */
    ...
    echo " <table border='0.5px' align='center' cellspacing='0'  style='width: 100%; border:none; text-align: center; font-size: 11pt; color:#000; font-family:helvetica,serif;'>
        ...
        echo "<td style='width:40%;text-align:left'>".$nombres."</td>";
