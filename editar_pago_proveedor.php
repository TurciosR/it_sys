    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <input type="hidden" id="forma" name="forma" value="<?php echo $forma ?>">
                <input type="hidden" id="id_movimiento" name="id_movimiento" value="<?php echo $id_movimiento ?>">
                <input type="hidden" id="id_voucher" name="id_voucher" value="<?php echo $id_voucher ?>">
                                ...
                                while ($row2=_fetch_array($rs)) {
                                  ...
                                  while ($row=_fetch_array($result)) {
                                    ...
                                    if ($i==1) {
                                      ...
                                      echo "<tr saldo_pend='$row[cargo]' class='$row[id_cuenta_pagar]' id='$row[id_cuenta_pagar]'>";
                                      ...
                                      echo "<td class='porcentaje nm'>$row[porcentage]</td>";
                                      echo "<td class='descuento '>$row[descuento]</td>";
                                      echo "<td class='devolucion ed'>$row[devolucion]</td>";
                                      echo "<td class='bonificacion ed'>$row[bonificacion]</td>";
                                      echo "<td class='retencion ed'>$row[retencion]</td>";
                                      echo "<td class='vin ed'>$row[vin]</td>";
                                    ...
                                    {
                                      echo "<tr saldo_pend='$cargo' class='$row[id_cuenta_pagar]' id='$row[id_cuenta_pagar]'>";
...
function insertar()
{
    ...
    while ($row2=_fetch_array($rs)) {
      ...
      $where_clause = "id_cuenta_pagar='" . $row2['id_cuenta_pagar'] . "' AND id_sucursal='$id_sucursal'";
    ...
    $table='voucher_mov';
    $where_clause="id_movimiento='".$id_voucher."'";
    $delete=_delete($table,$where_clause);
    if (!$delete)
    {
      $delval2=1;
    ...
    $where_up = "id_voucher='".$id_voucher."' AND id_sucursal='".$id_sucursal."'";
    $insertar12 = _update($table_up, $form_data_up, $where_up);
    if($insertar12)
    {
    ...
    if($ver1==0&&$ver1==0&&$ver2==0&&$ver3==0&&$ver4==0&&$delval1==0&&$delval2==0)
    {
      _commit();
