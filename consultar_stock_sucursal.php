											...
											<div class="col-md-12">
												...
												<table class="table table-striped" id='loadtable'>
													<thead class='thead1'>
														...
														<th class="text-success col10 th1 centrar">Estilo</th>
                                                        <th class="text-success col10 th1">Color</th>
														<th class="text-success col10 th1">Talla</th>
                                                        <th class="text-success col10 th1">Precio</th>
														<th class="text-success col10 th1">% Desc.</th>
                                                        <th class="red1 col10 th1">Exist. Centro </th>
                                                        <th class="blue1 col10 th1">Exist. Metro </th>
												</tr>
												</thead>
        ...
        while ($row = _fetch_array($query)) {
            ...
            $btnSelect='<input type="button" id="btnSelect" class="btn btn-primary fa" value="&#xf00c;">'; ?>
				   <tr class='tr1'  tabindex="<?php echo $filas; ?>">
                    ...
                    <td class='col10 td1 centrar'><?php echo $estilo; ?></td>
                    <td class='col10 td1'><?php echo $nombre; ?></td>
                    <td class='col10 td1'><?php echo $talla; ?></td>
                    <td class='col10 td1 td_success'>$ <?php echo $precio; ?></td>
					<td class='col10 td1 centrar'><?php echo $descuento; ?></td>
                    <td class='col10 td1 red1 centrar'><?php echo $sucursal_1; ?></td>
                    <td class='col10 td1 blue1 centrar'><?php echo $sucursal_2; ?></td>
          <?php
              $filas+=1;
        }
    }
