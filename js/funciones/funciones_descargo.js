    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        tr_add += '<td  class="cell100 column55 text-success">' + descripcion + '</td>';
				tr_add += "<td class='cell100 column10 text-success'><div class='col-xs-2'><input type='text'  class='form-control precio_compra' id='precio_compra' name='precio_compra'  value='"+costo+"' style='width:100px;' readOnly></div></td>";
...
function senddata() {
  ...
  dataString += '&tipo_descargo=' + tipo_descargo;
  dataString += '&origen=' + origen;
...
function cambio_preingreso(){
	...
	$.post("inventerio_inicial.php", {process:'genera_select',id:id }, function(data){
