...
<div class="modal-body">
	<div class="wrapper wrapper-content  animated fadeInRight">
	    ...
	    <input id="producto-img" name="producto-img[]" type="file">
	</div>
	<hr>
	<!--div class="col-md-12">
<div class="form-group has-info">
						 <button type="button"  id='btnGuardar' class="btn btn-lg btn-success btn-upload-3"><i class="fa fa-upload"></i> guardado</button>
					 </div>
				 </div-->
