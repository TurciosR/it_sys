...
function initial() {
	...
	$_PAGE ['links'] .= '<link href="css/plugins/awesomplete/awesomplete.css" rel="stylesheet">';
  $_PAGE ['links'] .= '<link href="css/style_ventas.css" rel="stylesheet">';
	...
	<div class="wrapper wrapper-content  animated fadeInRight">
			...
			<div class="col-lg-12">
					<?php
						...
						if ($links!='NOT' || $admin=='1' ){
							/*if ($turno_vigente=='1' ){
								$sql_detalle = _query("SELECT * FROM detalle_apertura WHERE id_apertura = '$id_apertura' AND vigente = 1 AND id_usuario != 0");
		...
		<div class="widget-content">
			...
			<table class="table table3">
				...
				<tr>
				<td class='col5'></td>
				<td class='col20' id='totaltexto'></td>
				<td class='col5'>&nbsp;</td>
				<td class='col10'>&nbsp;</td>
				<td class='col8'> </td>
				<td class='col10' id='totcant'>0.00</td>
			  <td class='col8' id='total_sin_descto'>$0.00</td>
				<td class='col8'  id='totdescto' >$0.00 </td>
				<td class='col8' id='total_gravado'>$0.00</td>
				<td class='col8'>&nbsp; </td>
				<td class='col8'>&nbsp; </td>
				</tr>
				</tbody>
			...
			<div class="col-md-12">
				...
				<table class="table" id='loadtable'>
					<thead class='thead1'>
						...
						<th class="text-success col12 th1">Marca</th>
						<th class="text-success col12 th1">Modelo</th>
						<th class="text-success col12 th1">Serie</th>
...
<?php
	...
	{
		echo "<div></div><br><br><div class='alert alert-warning'><h3 class='text-danger'>No se ha iniciado un turno</h3></div>";
	}
}   //apertura de caja
else {
...
echo "<script src='js/funciones/ventas3.js'></script>";
}
	  ...
	  if($id_reserva != "" && $id_reserva>0)
	  {
		...
		foreach ($array as $fila)
		{
			 if( $fila['precio_venta']>0 && $fila['cantidad']>0 )
			 {
				 ...
				 $sql_producto="SELECT costopro, ultcosto,modelo FROM productos WHERE id_producto='$id_producto'";
...
function consultar_stock(){
  ...
  //crear el select2 de precios
	...
	//echo $select0;
  $lista='<input class="awesomplete" data-list="Ada, Java, JavaScript, Brainfuck, LOLCODE, Node.js, Ruby on Rails" /> ';
...
function traerdatos() {
    ...
    $sqlJoined="SELECT pr.id_producto,pr.barcode, pr.descripcion, pr.precio1, pr.precio2, pr.precio3,
		 pr.costopro, pr.modelo, pr.exento, pr.marca,  pr.modelo,pr.serie, pr.generico, pr.descuento,
		 st.existencias
    ...
    if($num_rows > 0){
            ...
            <td class='col13 td1'><?php echo $descripcion;?></td>
						<td class='col12 td1 td_success'><?php echo $precio1;?></td>
            <td class='col12 td1'><?php echo $marca;?></td>
            <td class='col12 td1'><?php echo $modelo;?></td>
						<td class='col12 td1'><?php echo $serie;?></td>
