...
function initial() {
	...
	$_PAGE ['links'] .= '<link href="css/plugins/tabulator/tabulator.min.css" rel="stylesheet">';
...
echo "<script src='js/plugins/tabulator/tabulator.min.js'></script>";
echo "<script src='js/funciones/ventas2.js'></script>";
