...
function addProductList(id_prod,cantidad) {
  ...
  $.ajax({
   ...
   var input1='<input class="awesome1" value="'+precio1+'""/>';
  //  precios= '<input class="awesomplete" data-list="'+  lista_precios+'" value="'+data.precio1+'" />';
     ...
     tr_add += "<td class='text-success col10 td1' id='select_prec'>" +lista1+ "</td>";
     tr_add += "<td class='text-success col10 td1'><input type='hidden'  id='precio_venta_inicial' name='precio_venta_inicial' value='"+datax.precio1+"'><div class='col-xs-2'><input type='text'  class='form-control decimal'  id='precio_venta' name='precio_venta' value='"+datax.precio1+"' style='width:60px;'></div></td>";
