<?php
	...
	$sql="SELECT cxp.id_proveedor,proveedores.nombre, SUM(cxp.saldo_pend) as deuda FROM cxp JOIN proveedores ON proveedores.id_proveedor=cxp.id_proveedor WHERE cxp.id_sucursal=$id_sucursal GROUP BY cxp.id_proveedor ";
							...
							<?php
			 					while($row=_fetch_array($result))
			 					{
									...
									echo"<td><div class=\"btn-group\">
										...
										if ($link!='NOT' || $admin=='1' )
											echo "<li><a href=\"admin_cxp.php?id_proveedor=".$id_proveedor."\"><i class=\"fa fa-money\"></i> Cuentas</a></li>";
									}
									echo "</ul></div>";
