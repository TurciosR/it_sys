...
function initial()
{
    ...
    $sql = _query("SELECT * FROM almacen WHERE id_almacen='$id_almacen'");
...
function insertar()
{
  ...
  $sql_exis=_query("SELECT id_almacen FROM almacen WHERE descripcion ='$descripcion' AND id_almacen!='$id_almacen'");
  ...
  else
  {
      ...
      $where_clause = "id_almacen='" . $id_almacen . "'";
