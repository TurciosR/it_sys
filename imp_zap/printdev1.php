...
list($empresa,$sucursal,$razonsocial,$giro,$nit,$nrc,$tiquete,$fecha,$cliente,$dui_cte,$cajero,$vendedor,$turno,$pares,$transacc,$encab_tabla,$venta,$total,$totaltxt,$total_desc)=explode("|",$textoencodificado);
...
$string.=chr(13).$line0; // Print text
$string.= chr(27).chr(77)."0"; //FONT A
$string.= chr(27).chr(97).chr(1); //Center
$string.=chr(13)."   DEVOLUCION "."\n";
$string.=chr(13).$line0; // Print text
