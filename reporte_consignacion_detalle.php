...
$info_consignacion="";
$sql_fact="SELECT * FROM consignacion WHERE numero_doc='$numero_docx' and id_sucursal='$id_sucursal' ";
...
<page backtop="40mm" backbottom="40mm" backleft="15mm" backright="15mm" style="font-size: 12pt" backimgx="center" backimgy="bottom" backimgw="100%">
    <page_header>
        ...
        <table class="page_header" >
            ...
            <tr>
                <td align=center style='width:90%;'>CONSIGNACION No. <?php echo $numero_doc;?></td>
            </tr>
			<tr>
                <td align=center style='width:90%;'>CLIENTE:  <?php echo  $nombres;?> DUI <?php echo  $dui;?></td>
            </tr>
            <tr>
