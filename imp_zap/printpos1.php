...
list($empresa,$sucursal,$razonsocial,$giro,$nit,$nrc,$transacc,$tiquete,$fecha,$cliente,$cajero,$vendedor,$turno,$pares,$transacc,$encab_tabla,$venta,$total,$totaltxt,$total_desc)=explode("|",$textoencodificado);
