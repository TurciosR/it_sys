...
{
    $_PAGE = array();
    $_PAGE ['title'] = 'Verificacion de Traslado';
    $_PAGE ['links'] = null;
        ...
        <div class="ibox">
          <?php
            ...
            <div class="ibox-content">
              ...
              <div class="row">
                <div class="col-md-6">&nbsp;&nbsp;
                  <h3 class="text-navy" id='title-table'>&nbsp;Lista  de Productos Traslado No. <?php echo $idtransace; ?></h3>
                </div>
              </div>
              ...
              <div class='row'>
                <div class="col-md-12">&nbsp;
                  <div class="title-action" id='botones'>
                    <button type="button" id="submit1"  name="submit1" class="btn btn-primary"><i class="fa fa-save"></i> Verificar</button>
                  </div>
                </div>
              </div>
...
include_once("footer.php");
                            ...
                            echo "<script src='js/funciones/verificar_traslado.js'></script>";
                        } //permiso del script
    else {
...
function insertar()
{
    ...
    if ($cuantos>0) {
        ...
        $sql_pedido="SELECT * FROM traslado WHERE idtransace='$idtransace' AND id_sucursal_destino='$id_sucursal'";
        ...
        foreach ($array as $fila) {
                ...
                $stock_num=_num_rows($sql_stock);
                $numrows=round($stock_num,0);

                $sql_ultcosto=_query("SELECT productos.ultcosto FROM productos WHERE productos.id_producto='$id_producto'");
                $row_ultcosto=_fetch_array($sql_ultcosto);

                $ultcosto=$row_ultcosto['ultcosto'];
                ...
                if ($numrows>0) {
                  ...
                  $nuevo_stock=$stock_anterior+$recibido;
                  $tableS= 'stock';
                  $form_dataS = array(
