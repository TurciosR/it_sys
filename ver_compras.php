...
function initial() {
	...
	$sql0="SELECT total, numero_doc,pares,items, id_proveedor
	FROM compras AS cp
	...
	$row = _fetch_array($result);
  	...
  	$sql_prov = _query("SELECT percibe, retiene, retiene10 FROM proveedores WHERE id_proveedor='$id_proveedor'");
  	$dats = _fetch_array($sql_prov);
  	$percibe = $dats["percibe"];
  	$retiene = $dats["retiene"];
  	$retiene10 = $dats["retiene10"];
  	if($percibe)
  	{
  		$ret = "Percepcion 1%";
  		$per = 0.01;
...
<div class="modal-header">
	...
	<h4 class="modal-title">Ver Detalles de Compra</h4>
</div>
					...
					<section>
						<div class="table-responsive m-t">
							<table class="table table2 table-fixed table-striped "id="inventable">
								...
								<tfoot class='thead1'>
								<tr class='tr1'>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th colspan='2' class="text-success col18 th1">Subtotal</th>
								 <th class="text-success col11 th1"><?php echo round(($total/(1+$per+0.13)),2);?></th>
								</tr>
								<tr class='tr1'>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th colspan='2' class="text-success col18 th1">IVA</th>
								 <th class="text-success col11 th1"><?php echo round(($total/(1+$per+0.13))*0.13,2); ?></th>
								</tr>
								<tr class='tr1'>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th colspan='2' class="text-success col18 th1"><?php echo $ret; ?></th>
								 <th class="text-success col11 th1"><?php echo round(($total/(1+$per+0.13))*$per,2); ?></th>
								</tr>
								<tr class='tr1'>
									<th class="text-success c0l11 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th class="text-success col10 th1"></th>
								 <th colspan='2' class="text-success col18 th1">Total</th>
...
function buscarprodcant(){
 ...
 if(strpos($info, 'Windows') == TRUE)
	...
	$sql_dir_print="SELECT *  FROM config_pos";
