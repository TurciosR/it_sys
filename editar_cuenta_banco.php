...
function initial()
{
	...
	$sql = _query("SELECT * FROM cuenta_bancos WHERE id_cuenta='$id_cuenta'");
...
function edited()
{
	...
	$sql_result= _query("SELECT * FROM cuenta_bancos WHERE numero_cuenta='$numero' AND id_cuenta!='$id_cuenta'");
