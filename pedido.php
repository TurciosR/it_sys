    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
           <div class="row">
            ...
            $fecha_actual=date("Y-m-d");
						...
						echo "<div class='col-md-4'>";
						echo "<div class='form-group has-info single-line'><label>Fecha de Entrega:</label> <input type='text' placeholder='Fecha' class='datepick form-control' id='fecha1' name='fecha1' value='$fecha_actual'></div>";
						echo "</div>";//<div class='col-md-4'>"
						echo "<div class='col-md-6'>";
						echo "<div class='form-group has-info single-line'><label>Lugar de Entrega:</label> <input type='text' placeholder='lugar de entrega' class='form-control' id='lugar_entrega' name='lugar_entrega' value=''></div>";
						echo "</div>";//<div class='col-md-4'>"
						echo "</div>";//row
		...
		<!--/div-->
					...
					<div class="form-group has-info ">
						...
						<textarea placeholder="Observaciones"  class="form-control" id="observacion" name="observacion" rows='4' ></textarea>
						</div>
					</div>
					</div>
...
function insertar(){
  ...
  $observacion = $_POST['observacion'];
	...
	$numero_docx=numero_tiquete($ult_ped);
	$numero_doc =$numero_docx."_PED";
	...
	//if ($id=='1'){
		...
		if ($cuantos>0){
			//insertar a la tabla pedido
			//INSERT INTO pedido(id_pedido, id_cliente, fecha, numero_doc, total, id_usuario) VALUES ();
			$sql_fact="SELECT * FROM pedido WHERE numero_doc='$numero_doc' and fecha='$fecha_movimiento' AND id_sucursal='$id_sucursal'";
		  ...
		  $observacion=$_POST['observacion'];
			*/
			...
			if($insertar1 && $insertar2 && $insertar_fact && $insertar_fact_det){
					...
					$xdatos['msg']='pedido Numero: <strong>'.$numero_doc.'</strong>  Guardada con Exito !';
...
function print2(){
	...
	$nreg_encode['pedido'] = $info_pedido;
	$nreg_encode['sist_ope'] =$so_cliente;
	echo json_encode($nreg_encode);
