...
function buscarPedido(idtransace) {
  //para cargar pedido y detalle pedido
  urlprocess = $('#urlprocess').val();

  var dataString = 'process=buscarpedido' + '&idtransace=' + idtransace;
  $.ajax({
    type: "POST",
    url: urlprocess,
    data: dataString,
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (tipe == 0) {
        ...
        tr_add += "<td class='col col-lg-2 '><div class='col-lg-8'><input type='text'  class='form-control decimal' id='cant' name='cant' value='" + cantidad + "' readOnly></div></td>";
        tr_add += "<td class='col col-lg-2 '><div class='col-lg-8'><input type='text'  class='form-control decimal' id='recv' name='recv' value='" + tipe + "' ></div></td>";
        tr_add += "<td class='col col-lg-2 '><div class='col-lg-12'><label id='comentario' name='comentario'></label></div></td>";
...
function reload1() {
  urlprocess2 = 'admin_traslados_recibidos_rangos_nofin.php';
