...
function initial() {
	...
	$_PAGE = array ();
	$_PAGE ['title'] = 'Reporte caja chica';
	$_PAGE ['links'] = null;
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Generación de Reportes por rango de fechas de caja chica</h5>
                        </div>
                        <div class="ibox-content">
                              <form name="formulario" id="formulario" method="GET" action="ver_reporte_caja.php" target="_blank">
                              <div class="row">
                                <div class="col-md-4">
                                ...
                                <input type="hidden" name="sucursal" id="sucursal" value="<?php echo $_SESSION["id_sucursal"]?>">
                                 <div class="col-md-4">
