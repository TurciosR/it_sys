...
function senddata() {
  ...
  $('#tabla tr ').each(function(index) {
    ...
    dataString="process="+process+"&array_json="+json_arr+"&array_json2="+json_arr2+"&id_cuenta="+id_cuenta+"&total_a_p="+total_a_p+"&id_proveedor="+id_proveedor;
...
function reload1() {
  location.href = 'pago_proveedores.php';
}
