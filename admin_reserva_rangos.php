<?php
	...
	// Page setup
	$_PAGE = array ();
	$title='Administrar Reservación de Productos (Buscar por Fechas)';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='reservas.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar</a>";
				echo "</div>";
				//permiso del script
...
<?php
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_reserva_rangos.js'></script>";
		} //permiso del script
else {
