               ...
               $fecha_actual=date("Y-m-d");
						...
						<div class='col-md-3'>
							<div class='form-group has-info'>
										...
										<input type='text' placeholder='Fecha' class='datepick form-control' id='fecha' name='fecha' value='<?php echo $fecha_actual;?>'>
										</div>
						</div>
							...
							<!--selecciona tipo de impresion -->
								<div class="col-md-3">
									<div class="form-group has-info">
											 <div class="form-group">	<label>Tipo Impresion</label></div>

										<select  name='tipo_impresion' id='tipo_impresion'  class='form-control' readOnly>
		...
		<div class="modal-dialog">
			<div class="modal-content modal-sm">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" id="btnPrintFact"><i class="fa fa-print"></i> F1 Imprimir</button>
				</div>
				</div>
			</div>
		</div>
...
$sql_dir_print="SELECT dir_print_script,shared_printer_win FROM empresa";
