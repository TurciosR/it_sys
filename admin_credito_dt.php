...
$id_sucursal=$_SESSION['id_sucursal'];
$joinQuery ="  FROM credito LEFT JOIN clientes ON clientes.id_cliente=credito.id_cliente";
...
$columns = array(
  ...
  array( 'db' => '`clientes`.`nombre`', 'dt' => 2, 'field' => 'nombre'),
  ...
  array( 'db' => '`credito`.`id_credito`', 'dt' => 8, 'formatter' => function ($id_credito, $row) {
