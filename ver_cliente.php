...
$sql="SELECT p.*, d.nombre_departamento, m.nombre_municipio, c.nombre as cat  FROM clientes as p, departamento as d, municipio as m, categoria_proveedor as c WHERE id_cliente='$id_cliente' AND p.depto = d.id_departamento AND p.municipio = m.id_municipio AND p.categoria = c.id_categoria";
$result = _query($sql);
						...
						<tbody>
							<?php
								while ($row = _fetch_array($result))
								{
									...
									echo"<tr><td>Teléfonos</td><td>".$telefono1." y ".$telefono2."</td></tr>";
