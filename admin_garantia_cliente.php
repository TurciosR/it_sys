<?php
	include ("_core.php");
	// Page setup
	$title='Administrar Garantías Clientes';
	$_PAGE = array ();
	$_PAGE ['title'] = 	$title;
	$_PAGE ['links'] = null;
				...
				<div class='ibox-title'>
					<div class='row'>
						<div class="input-group">
							...
							<div class="form-group">
									<div><label>Buscar Garantias</label> </div>
									<button type="button" id="btnMostrar" name="btnMostrar" class="btn btn-primary"><i class="fa fa-check"></i> Mostrar Garantias</button>
...
<?php
	...
	echo" <script type='text/javascript' src='js/funciones/funciones_garantia_cte.js'></script>";
	} //permiso del script
else {
