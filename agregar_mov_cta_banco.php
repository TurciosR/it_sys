...
function insert()
{
	...
	$sql_result= _query("SELECT * FROM mov_cta_banco WHERE id_cuenta='$id_cuenta' AND numero_doc='$numero_doc'");
	$numrows=_num_rows($sql_result);

	$sql = _query("SELECT saldo FROM mov_cta_banco ORDER BY id_movimiento DESC LIMIT 1");
