...
$sql="SELECT p.*, d.nombre_departamento, m.nombre_municipio, c.nombre as cat, tp.nombre as tprov  FROM proveedores as p, departamento as d, municipio as m, categoria_proveedor as c, tipo_proveedor as tp WHERE id_proveedor='$id_proveedor' AND p.depto = d.id_departamento AND p.municipio = m.id_municipio AND p.categoria = c.id_categoria AND p.tipo = tp.id_tipo";
$result = _query($sql);
