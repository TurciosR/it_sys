<?php
	...
	// Page setup
	$_PAGE = array ();
	$_PAGE ['title'] = 'Administrar Consignaciones';
	$_PAGE ['links'] = null;
	...
	WHERE consignacion.id_sucursal='$id_sucursal'
	ORDER BY finalizada
	";
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<header>
						<h4>Administrar consignacion</h4>
					</header>
					<section>
 					...
 					if ($count>0){
						for($i=0;$i<$count;$i++){
							...
							if($txt_estado=='NULA'|| $txt_estado=='FINALIZADA' ){
								...
								echo "<td>";
								echo "<h5 class='text-primary'>"."ABONADO $ ".$abono_consignado_format."</h5>";
								echo "<h5 class='text-primary'>"."SALDO PENDIENTE $ ".$saldo_pendiente_format."</h5>";
								echo"</td>";
								echo "<td><h5 class='text-mutted'>".$txt_estado."</h5></td>";
							}
							if($txt_estado=='PENDIENTE'){
								echo "<td><strong>".$id_consignacion."</strong></td>";
							...
							**/
							echo"<td><div class=\"btn-group\">
								...
								/*
								$filename='borrar_consignacion.php';
							$link=permission_usr($id_user,$filename);
							if ($link!='NOT' || $admin=='1' ){
								echo"<li><a data-toggle='modal' href='$filename?id_consignacion=" .  $row ['id_consignacion']."&process=formDelete"."' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-eraser\"></i> Eliminar</a></li>";
							}
							*/
