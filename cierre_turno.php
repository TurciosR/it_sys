...
function initial() {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $sql_corte = _query("SELECT * FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND id_sucursal = '$id_sucursal'");

  $cuenta = _num_rows($sql_corte);
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $sql_min_max = _query("SELECT MIN(numero_doc) as minimo, MAX(numero_doc) as maximo FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND alias_tipodoc = 'TIK' AND id_sucursal = '$id_sucursal' UNION ALL SELECT MIN(numero_doc) as minimo, MAX(numero_doc) as maximo FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND alias_tipodoc = 'FAC' AND id_sucursal = '$id_sucursal' UNION ALL SELECT MIN(numero_doc) as minimo, MAX(numero_doc) as maximo FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND alias_tipodoc = 'CCF' AND id_sucursal = '$id_sucursal' UNION ALL SELECT MIN(numero_doc) as minimo, MAX(numero_doc) as maximo FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND alias_tipodoc = 'DEV' AND id_sucursal = '$id_sucursal' UNION ALL SELECT MIN(numero_doc) as minimo, MAX(numero_doc) as maximo FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND alias_tipodoc = 'RES' AND id_sucursal = '$id_sucursal' ");
  //echo "SELECT * FROM factura WHERE fecha_doc = '$fecha_apertura' AND id_apertura = '$id_apertura' AND hora BETWEEN '$hora_apertura' AND '$hora_actual' AND id_sucursal = '$id_sucursal'";
  ...
  $total_corte = $total_tike_e + $total_factura_e + $total_credito_fiscal_e + $total_tike_g + $total_factura_g + $total_credito_fiscal_g + $total_reserva_g + $total_reserva_e + $monto_apertura + $total_entrada_caja - $total_salida_caja;
			...
			<div class="col-md-4">
              <div class="form-group has-info single-line">
                  <label>Total Corte Caja $ </label>
                  	<input type="text" id="total_corte" name="total_corte" value="<?php echo $total_corte;?>"  class="form-control decimal" readOnly >
              </div>
			</div>
			<div class="col-md-4">
              <div class="form-group has-info single-line">
        	...
        	<tbody>
        		<tr>
        			...
        			<td style="text-align: center">
        				<label id="id_total_general"><?php echo $total_corte;?></label></td>
        			<td style="text-align: center">
        				<label id="id_diferencia"><?php echo "-".$total_corte;?></label>
        			</td>
        		</tr>
        	</tbody>
        </table>
...
<div class="modal-footer">
	<div class="row df" <?php if($val == 1){ echo "hidden";}?>>
		<div class="col-md-12">
			...
			<button type="button" class="btn btn-default df" data-dismiss="modal">Close</button>
		</div>
	</div>
	<div class="row af" <?php if($val == 0){ echo "hidden";}?>>
		<div class="col-md-12">
...
function confirmar()
{
	$user = $_POST["user"];
	$pass = md5($_POST["pass"]);
	$sql_user = _query("SELECT * FROM empleados WHERE usuario = '$user' AND password = '$pass'");
