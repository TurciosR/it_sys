...
function initial()
{
	...
	$sql = _query("SELECT * FROM mov_cta_banco WHERE id_movimiento='$id_movimiento'");
...
function insert()
{
	...
	$sql = _query("SELECT saldo FROM mov_cta_banco WHERE id_movimiento<'$id_movimiento' ORDER BY id_movimiento DESC LIMIT 1");
