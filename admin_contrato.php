	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='contrato.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Contrato</a>";
						...
						<table class="table table-striped table-bordered table-hover" id="editable2">
							<thead>
								<tr>
									...
									<th class="col-lg-5">Cliente</th>
									<th class="col-lg-1">Monto</th>
									<th class="col-lg-1">Fecha Inicio</th>
...
<?php
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_contrato.js'></script>";
	}
	else {
