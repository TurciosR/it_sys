				...
				<div class='ibox-title'>
					<div class="row">
						...
						<div class="col-lg-2">
							<div>
								<label>Desde</label>
								<input type="text" name="fin" id="fin" class="form-control datepick2" value="<?php echo ED($fin); ?>">
							</div>
						</div>
						<div class="col-lg-2">
							<div>
								<label>Hasta</label>
								<input type="text" name="fini" id="fini" class="form-control datepick2" value="<?php echo ED($fini); ?>">
							</div>
						</div>
						<div class="col-lg-2">
							<div>
