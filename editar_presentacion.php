...
echo "<input type='hidden' name='id_presentacion' id='id_presentacion' value='$id_presentacion'>";
				...
				<table class="table table-bordered table-striped" id="tableview">
					...
					<tbody>
							...
							if ($count>0) {
								...
								for($i = 0; $i < $count; $i ++) {
									...
									$descrip_corta=$row['descrip_corta'];
										...
										echo "<tr><td>Descripcion:</td><td><input type='text' id='descripcion' name='descripcion' value='$descripcion'  class='form-control'></td></tr>";
										echo "<tr><td>Descripcion Corta:</td><td><input type='text' id='descrip_corta' name='descrip_corta' value='$descrip_corta'  class='form-control'></td></tr>";
										echo "<tr><td></td></tr>";
									}
								}
							?>
						...
						<tfoot>
						<td align='center'><button type="button" class="btn btn-primary" id="btnEditarPresenta"><i class="fa fa-save"></i> Guardar</button> </td>
