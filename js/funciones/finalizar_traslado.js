...
function totales(){
	...
	$('#totaltexto').load('finalizar_traslado.php?'+'process=total_texto&total='+total_dinero);
}	
...
//Generar pdf de finalizar_traslado
function imprimir_pdf(){
	
	var numero_doc=$("#numero_doc").val();
	var dataString='numero_doc='+numero_doc; 
	cadena = "ver_reporte_finalizar_traslado.php?"+dataString ;	
	window.open(cadena, '', '');	    
}
