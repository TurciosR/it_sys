...
function initial() {
	...
	$_PAGE ['links'] .= '<link href="css/plugins/selectize/selectize.css" rel="stylesheet">';
					...
					<div class="widget">
						<div class="row">
							 <div class="col-md-12">
								 ...
								 <div class="row">
						 					<div class="col-md-12">
						 				<div class="col-md-12 border_divx">
						 					<div class="col-md-12">
...
echo "<script src='js/funciones/ventas4.js'></script>";
//echo "<script src='js/funciones/tablenav.js'></script>";
}
