...
function crear_select2($nombre,$array,$id_valor,$style,$clase=''){
  $txt='';
  //style='width:200px' <select id="select2-single-input-sm" class="form-control input-sm select2-single">
  $clases='select2 form-control input-sm select2-single '.$clase;
	$txt.= "<select ". " class='$clases'  name='$nombre' id='$nombre' style='$style'".">";
...
$minusculas = strtr(strtolower($cadena),"ÀÈÌÒÙÁÉÍÓÚÇÑÄËÏÖÜ","àèìòùáéíóúçñäëïöü");
return $minusculas;
}
?>
