...
function initial() {
	...
	$_PAGE = array ();
	$_PAGE ['title'] = 'Reporte de Venta de Productos por Empleado';
	$_PAGE ['links'] = null;
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                              <form name="formulario" id="formulario" method="GET" action="ver_reporte_productos_empleado.php" target="_blank">
                              <div class="row">
                                <div class="col-md-4">
