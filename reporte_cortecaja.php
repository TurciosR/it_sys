...
function initial() {
	...
	$title='Reporte de cortes de Caja por Rango de Fechas';
	$_PAGE = array ();
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                              <form name="formulario" id="formulario" method='GET' action='ver_reporte_cortecaja.php' target='_blank'>
                              <div class="row">
                                <div class="col-md-4">
                                 ...
                                 <!--div class="col-md-4">
                                  <div class="form-group has-info single-line">
                                    <label class="control-label">Seleccione Ventas</label>
