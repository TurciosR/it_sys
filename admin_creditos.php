...
?>
    ...
    echo "<div></div></div></div></div></div><div class='alert alert-warning'>No tiene permiso para este modulo.</div>";
			}

include("footer.php");
echo" <script type='text/javascript' src='js/funciones/funciones_creditos.js'></script>";
?>
